...
## DESNZ weekly road fuels

The source publishes the history in two seven-column CSV artifacts. The frozen
file covers 9 June 2003 through 2017 and the rolling file covers 2018 through
the latest reference week. Both attachment URLs are discovered from the
official page on every run, their schemas are checked before parsing and their
rows are stitched without aggregation.

The six stored series are ULSP and ULSD pump price, duty rate and VAT rate.
Prices and duties retain the published pence-per-litre levels; VAT retains the
published percentage. The collector never stores monthly averages, MoM, YoY or
